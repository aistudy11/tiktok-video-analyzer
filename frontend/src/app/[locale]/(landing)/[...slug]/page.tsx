...
export async function generateMetadata({
  ...
  // filter invalid slug (internal webpack/next.js routes)
  if (staticPageSlug.includes('.') ||
      staticPageSlug.startsWith('_') ||
      staticPageSlug.startsWith('__') ||
      staticPageSlug.includes('webpack') ||
      staticPageSlug.includes('hmr')) {
    return;
  }
